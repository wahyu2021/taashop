...
import { Save, UserCircle, Star, Info, Image as ImageIcon } from 'lucide-react';
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="customer_title" className="text-xs font-bold uppercase tracking-widest text-stone-500">
                                            Jabatan/Komunitas (Opsional)
                                        </Label>
                                        <Input 
                                            id="customer_title"
                                            placeholder="Contoh: Kapten FC Maju Jaya"
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <select 
                                            ...
                                            className="w-full bg-stone-50 border border-stone-200 rounded-lg h-10 px-3 text-sm focus:ring-primary focus:border-primary"
                                        >
                                            {[5, 4, 3, 2, 1].map(num => (
                        ...
                        >
                            <div className="space-y-6">
                                ...
                                <p className="text-[10px] text-center text-stone-400 uppercase tracking-widest font-bold">
                                    Upload screenshot WhatsApp atau foto pelanggan saat menerima produk.
                                </p>
                            </div>
                        </AdminSectionCard>
                    </form>
                    ...
                    <AdminSectionCard icon={Star} title="Foto Profil">
                        <div className="space-y-4">
                            ...
                            <div className="text-center">
                                <p className="text-[10px] text-stone-400 font-bold uppercase tracking-widest">Foto Wajah Pelanggan</p>
                            </div>
                        </div>
                    </AdminSectionCard>
                </div>
