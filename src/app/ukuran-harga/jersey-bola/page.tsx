    ...
    return (
        <div className="dark:bg-gray-900">
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4 space-y-6">
                    <h1 className="text-5xl md:text-6xl font-bold drop-shadow-2xl">
                        Ukuran & Harga Jersey Bola
                    </h1>
                    <p className="text-lg md:text-xl max-w-3xl drop-shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                        <Link
                            href="/kontak"
                            className="group flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 px-8 rounded-full text-lg transition"
                        >
                            Pesan Sekarang
                        ...
                        <Link
                            href="#panduan-ukuran"
                            className="flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur px-7 py-3 rounded-full border border-white/30 text-lg font-semibold transition"
                        >
            ...
            {/* Main Content */}
            <main className="py-16 sm:py-24 overflow-x-hidden">
                {/* How to Order Section */}
                <AnimatedSection>
                    <HowToOrderSection
                        description="Hanya dengan 4 langkah mudah, Anda bisa mendapatkan jersey impian untuk tim Anda."
                        steps={[
                            {
                                title: "Pilih Paket",
                                description:
                                    "Pilih paket jersey yang paling sesuai dengan kebutuhan Anda dari pilihan di atas.",
                            },
                            {
                                title: "Kirim Desain",
                                description:
                            ...
                            },
                            {
                                title: "Pengiriman",
                                description:
                                    "Jersey siap dikirim ke alamat Anda dengan aman dan tepat waktu.",
                            },
                        ]}
                    />
                </AnimatedSection>
                    ...
                    <section className="container mx-auto px-4 mt-24">
                        <div className="text-center max-w-3xl mx-auto">
                            <h2 className="text-4xl font-bold mb-4">
                                Pilihan Model & Paket Jersey
                            </h2>
                            <p className="text-lg text-gray-600 dark:text-gray-300">
                                Kami menyediakan berbagai pilihan paket jersey
                                bola yang dapat disesuaikan dengan kebutuhan dan
                                budget tim Anda. Mulai dari paket ekonomis
                ...
                <AnimatedSection delay={300}>
                    <MaterialsSection
                        className="mt-24"
                        heading="Detail Bahan Jersey Bola"
                        intro="Bahan-Bahan berkualitas yang kami gunakan untuk Jersey Bola custom Anda"
            ...
            <section className="bg-gray-100 dark:bg-gray-800">
                <div className="container mx-auto px-4 py-16 text-center">
                    ...
                    <Link
                        href="/kontak"
                        className="bg-orange-600 text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-orange-700 transition"
                    >
                        Hubungi Kami
                    </Link>
                </div>
